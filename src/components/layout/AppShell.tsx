...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <SidebarEdgeTrigger />
      <main
        className={`${pinned ? 'md:ml-[240px]' : 'md:pl-12'} ${topBar ? 'md:pt-11' : 'md:pt-0'} pb-20 md:pb-0 mobile-content-top min-h-screen bg-bg flex flex-col transition-[margin,padding] duration-200`}
      >
        <CostChromeGate />
